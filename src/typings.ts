...
export const CFX_MASTERLIST = 'https://servers-frontend.fivem.net/api/servers/single/'

export const CFX_STATUS_SUMMARY = 'https://status.cfx.re/api/v2/status.json'

export const CFX_STATUS_COMPONENTS = 'https://status.cfx.re/api/v2/components.json'

// Element Club

export const NONE = 'none'

export const AURUM = 'au'

export const ARGENTUM = 'ag'
